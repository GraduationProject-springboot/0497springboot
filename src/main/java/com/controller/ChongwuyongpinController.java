                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            ChongwuyongpinEntity chongwuyongpinEntity = new ChongwuyongpinEntity();
//                            chongwuyongpinEntity.setChongwuyongpinName(data.get(0));                    //宠物用品名称 要改的
//                            chongwuyongpinEntity.setChongwuyongpinPhoto("");//详情和图片
//                            chongwuyongpinEntity.setChongwuyongpinTypes(Integer.valueOf(data.get(0)));   //宠物用品类型 要改的
//                            chongwuyongpinEntity.setChongwuyongpinKucunNumber(Integer.valueOf(data.get(0)));   //宠物用品库存 要改的
//                            chongwuyongpinEntity.setChongwuyongpinOldMoney(data.get(0));                    //原价 要改的
