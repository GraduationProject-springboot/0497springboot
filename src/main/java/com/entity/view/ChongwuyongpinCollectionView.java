...
public class ChongwuyongpinCollectionView extends ChongwuyongpinCollectionEntity implements Serializable {
	...
	*/
	...
	private String chongwuyongpinCollectionValue;
	...
	public ChongwuyongpinCollectionView() {

	}

	public ChongwuyongpinCollectionView(ChongwuyongpinCollectionEntity chongwuyongpinCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, chongwuyongpinCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getChongwuyongpinCollectionValue() {
		return chongwuyongpinCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setChongwuyongpinCollectionValue(String chongwuyongpinCollectionValue) {
		this.chongwuyongpinCollectionValue = chongwuyongpinCollectionValue;
	}
	...
	public String toString() {
		return "ChongwuyongpinCollectionView{" +
			", chongwuyongpinCollectionValue=" + chongwuyongpinCollectionValue +
