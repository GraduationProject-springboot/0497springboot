...
public class ChongwuyongpinCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ChongwuyongpinCollectionEntity() {

	}

	public ChongwuyongpinCollectionEntity(T t) {
		try {
     ...
     * 宠物用品
     */
    @ColumnInfo(comment="宠物用品",type="int(11)")
    ...
    public String toString() {
        return "ChongwuyongpinCollection{" +
            ", id=" + id +
            ", chongwuyongpinId=" + chongwuyongpinId +
            ", yonghuId=" + yonghuId +
            ", chongwuyongpinCollectionTypes=" + chongwuyongpinCollectionTypes +
